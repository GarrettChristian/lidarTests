...
def create_model():
  ...
  model.add(layers.Conv2D(filters=64, kernel_size=(11, 11), strides=(4, 4), activation='relu', padding='same'))
  ...
  model.add(layers.Dense(8192, activation="softmax"))
  ...
  model.add(layers.Conv2DTranspose(filters=384, kernel_size=(3, 3), strides=(2, 2), activation='relu', padding='same'))
  model.add(layers.BatchNormalization())

  model.add(layers.Conv2DTranspose(filters=256, kernel_size=(5, 5), strides=(2, 2), activation='relu', padding='same'))
  model.add(layers.BatchNormalization())

  model.add(layers.Conv2DTranspose(filters=64, kernel_size=(11, 11), strides=(2, 2), activation='relu', padding='same'))
  model.add(layers.BatchNormalization())
