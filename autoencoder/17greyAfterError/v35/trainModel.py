...
def create_model():
  ...
  model.add(layers.Conv2D(filters=8, kernel_size=(11, 11), strides=(4, 4), activation='relu', padding='same'))
  ...
  model.add(layers.Conv2D(filters=8, kernel_size=(11, 11), strides=(1, 1), activation='relu', padding='same'))
  model.add(layers.BatchNormalization())
  model.add(layers.UpSampling2D(size=(2, 2)))  
