...
def create_model():
  ...
  model.add(layers.Conv2D(filters=64, kernel_size=(4, 4), strides=(1, 1), activation='relu', padding='same')) # orig 16
  ...
  model.add(layers.UpSampling2D((2, 2)))
  model.add(layers.Conv2D(1, kernel_size=(4, 4), strides=(1, 1), activation='sigmoid', padding='same'))
